...
+ (*submitted*) **Lee, A.** (2026). Optionality in Malay morphophonology using weighted logic. the Annual Meeting on Phonology 2026 (AMP), College Park, MD, USA.
...
+ (*upcoming*) **Lee, A.** (2026). Revisiting asymmetries in Malay morphophonology. Poster at the 62nd Annual Meeting of the Chicago Linguistic Society (CLS), Chicago, IL, USA. 

+ Pan, Y., Cai, H., **Lee, A.**, Li, A. (2025). Validating elicited imitation with eye tracking data. Talk at the 26th Midwest Association of Language Testers Conference (MwALT), East Lansing, MI, USA.